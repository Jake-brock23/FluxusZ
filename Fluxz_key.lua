...
--! configuration
local service = 1053;  -- your service id, this is used to identify your service.
local secret = "a3fc606a-f143-498b-982d-5b87b6508c0b";  -- make sure to obfuscate this if you want to ensure security.
...
if isfile(savedKeyPath) then
    ...
    if verifyKey(savedKey) then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Jake-brock23/FluxusZ/main/FluxusZ%20UI.lua"))()
        return
    end
end
...
headerFrame.Position = UDim2.new(0.05, 0, 0, 80)
headerFrame.BackgroundTransparency = 1
headerFrame.Parent = main

local headshot = Instance.new("ImageLabel")
headshot.Size = UDim2.new(0, 35, 0, 35)
headshot.Position = UDim2.new(0, 0, 0.5, -17)
headshot.BackgroundTransparency = 1
headshot.Image = Players:GetUserThumbnailAsync(player.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size48x48)
headshot.Parent = headerFrame

local welcomeText = Instance.new("TextLabel")
welcomeText.Size = UDim2.new(1, -40, 1, 0)
welcomeText.Position = UDim2.new(0, 40, 0, 0)
...
welcomeText.Parent = headerFrame
...
verify.MouseButton1Click:Connect(function()
    ...
    if success then
        sideNotify("Valid key! Loading FluxusZ...", 3)
        writefile(savedKeyPath, enteredKey)
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Jake-brock23/FluxusZ/main/FluxusZ%20UI.lua"))()
        gui:Destroy()
    else
        sideNotify("Your key is invalid.", 3)
    end
end)
